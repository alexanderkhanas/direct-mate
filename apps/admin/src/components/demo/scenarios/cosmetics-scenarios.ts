...
export const COSMETICS_SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    turns: [
      ...
      { role: 'user', text: 'Так' },
      { role: 'bot', text: 'Замовлення прийнято 💛 Денний крем — 450 UAH. Очікуйте на дзвінок' },
    ],
  },
  {
    ...
    turns: [
      ...
      { role: 'bot', text: 'Чудово 💛 Оформлюємо?' },
      { role: 'user', text: 'Так' },
      { role: 'bot', text: 'Замовлення прийнято 💛 Сироватка з вітаміном С — 580 UAH. Очікуйте на дзвінок' },
    ],
  },
];

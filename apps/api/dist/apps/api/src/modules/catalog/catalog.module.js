...
exports.CatalogModule = CatalogModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([product_entity_1.Product, product_variant_entity_1.ProductVariant, stock_balance_entity_1.StockBalance, product_media_entity_1.ProductMedia])],
        controllers: [catalog_controller_1.CatalogController],
        providers: [catalog_service_1.CatalogService],
        exports: [catalog_service_1.CatalogService, typeorm_1.TypeOrmModule],
    })
], CatalogModule);

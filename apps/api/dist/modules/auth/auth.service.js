...
const base_1 = require("../../scripts/seed/templates/base");
const clothing_1 = require("../../scripts/seed/templates/clothing");
let AuthService = class AuthService {
    ...
    async createDefaultTemplates(manager, tenantId) {
        ...
        for (const t of base_1.BASE_TEMPLATES)
            merged.set(t.scenario, t);
        for (const t of clothing_1.CLOTHING_TEMPLATES)
            merged.set(t.scenario, t);

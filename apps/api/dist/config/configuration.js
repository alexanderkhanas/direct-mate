...
exports.default = () => ({
    ...
    demo: {
        ...
        rateLimit: {
            sessionsPerHour: parseInt(process.env.DEMO_RATE_LIMIT_SESSIONS_PER_HOUR ?? '5', 10),
        },
        budget: {
            classifierCentsPerDay: parseInt(process.env.DEMO_BUDGET_CENTS_GPT54_MINI ?? '1500', 10),
            fallbackCentsPerDay: parseInt(process.env.DEMO_BUDGET_CENTS_GPT54 ?? '500', 10),
        },
        cors: {
            allowedOrigins: (process.env.DEMO_CORS_ALLOWED_ORIGINS ??

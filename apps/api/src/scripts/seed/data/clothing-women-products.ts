...
export const CLOTHING_WOMEN_PRODUCTS: ProductSpec[] = [
  // ── Zara (6) ────────────────────────────────────────────────
  {
    ...
    variants: [
      { color: 'Білий', size: 'S', price: 799, stock: 15 },
      { color: 'Білий', size: 'M', price: 799, stock: 12 },
      { color: 'Білий', size: 'L', price: 799, stock: 10 },
      { color: 'Чорний', size: 'S', price: 799, stock: 15 },
      { color: 'Чорний', size: 'M', price: 799, stock: 8 },
      { color: 'Чорний', size: 'L', price: 799, stock: 5 },
      { color: 'Чорний', size: 'XL', price: 799, stock: 0 },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      { color: 'Чорний', size: 'XS', price: 1599, stock: 5 },
      { color: 'Чорний', size: 'S', price: 1599, stock: 15 },
      { color: 'Чорний', size: 'M', price: 1599, stock: 15 },
      { color: 'Чорний', size: 'L', price: 1599, stock: 5 },
  ...
  },
  {
    ...
    variants: [
      { color: 'Білий', size: 'S', price: 1199, stock: 5 },
      { color: 'Білий', size: 'M', price: 1199, stock: 15 },
      { color: 'Білий', size: 'L', price: 1199, stock: 5 },
  ...
  },
  {
    ...
    variants: [
      { color: 'Білий', size: 'S', price: 599, stock: 15 },
      { color: 'Білий', size: 'M', price: 599, stock: 15 },
      { color: 'Білий', size: 'L', price: 599, stock: 15 },
    ],
  },
  ...
  // ── H&M (6) ─────────────────────────────────────────────────
  {
    ...
    variants: [
      ...
      { color: 'Чорний', size: 'W26', price: 1099, stock: 15 },
      { color: 'Чорний', size: 'W28', price: 1099, stock: 15 },
      { color: 'Чорний', size: 'W30', price: 1099, stock: 5 },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      { color: 'Білий', size: 'S', price: 749, stock: 15 },
      { color: 'Білий', size: 'M', price: 749, stock: 15 },
      { color: 'Білий', size: 'L', price: 749, stock: 5 },
      { color: 'Чорний', size: 'S', price: 749, stock: 15 },
      { color: 'Чорний', size: 'M', price: 749, stock: 15 },
      { color: 'Чорний', size: 'L', price: 749, stock: 15 },
      { color: 'Чорний', size: 'XL', price: 749, stock: 5 },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      { color: 'Чорний', size: 'S', price: 1599, stock: 5 },
      { color: 'Чорний', size: 'M', price: 1599, stock: 5 },
      { color: 'Чорний', size: 'L', price: 1599, stock: 5 },
    ],
  },
  ...
  // ── Mango (6) ───────────────────────────────────────────────
  {
    ...
    variants: [
      { color: 'Чорний', size: 'S', price: 2899, stock: 5 },
      { color: 'Чорний', size: 'M', price: 2899, stock: 5 },
      { color: 'Чорний', size: 'L', price: 2899, stock: 5 },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      { color: 'Чорний', size: null, price: 2299, stock: 15 },
  ...
  },
  {
    ...
    variants: [
      { color: 'Чорний', size: 'M', price: 2499, stock: 5 },
    ],
  },
  {
    ...
    variants: [
      { color: 'Чорний', size: 'S', price: 1799, stock: 15 },
      { color: 'Чорний', size: 'M', price: 1799, stock: 15 },
      { color: 'Чорний', size: 'L', price: 1799, stock: 5 },
      { color: 'Білий', size: 'S', price: 1799, stock: 15 },
      { color: 'Білий', size: 'M', price: 1799, stock: 15 },
    ],
  },
  {
    ...
    variants: [
      { color: 'Білий', size: 'XS', price: 1500, stock: 5, imageFile: 'zara-midi-white.jpg' },
      { color: 'Білий', size: 'S', price: 1500, stock: 12, imageFile: 'zara-midi-white.jpg' },
      { color: 'Білий', size: 'M', price: 1500, stock: 12, imageFile: 'zara-midi-white.jpg' },
      { color: 'Білий', size: 'L', price: 1500, stock: 8, imageFile: 'zara-midi-white.jpg' },
      { color: 'Коричневий', size: 'XS', price: 1500, stock: 5, imageFile: 'zara-midi-brown.jpg' },
      { color: 'Коричневий', size: 'S', price: 1500, stock: 12, imageFile: 'zara-midi-brown.jpg' },
      { color: 'Коричневий', size: 'M', price: 1500, stock: 12, imageFile: 'zara-midi-brown.jpg' },
      { color: 'Коричневий', size: 'L', price: 1500, stock: 8, imageFile: 'zara-midi-brown.jpg' },
    ],
  },
];
